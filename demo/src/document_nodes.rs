...
pub fn create_document_node() -> Node {
    ...
    attrs.insert("title".to_string(), AttributeSpec {
        default: Some(Value::String("新文档".to_string()))
    });
    attrs.insert("description".to_string(), AttributeSpec {
        default: Some(Value::String("".to_string()))
    });
    attrs.insert("created_at".to_string(), AttributeSpec {
        default: Some(Value::String(chrono::Utc::now().to_rfc3339()))
    });
    attrs.insert("author".to_string(), AttributeSpec {
        default: Some(Value::String("".to_string()))
    });
...
pub fn create_paragraph_node() -> Node {
    ...
    attrs.insert("indent".to_string(), AttributeSpec {
        default: Some(Value::Number(serde_json::Number::from(0)))
    });
    attrs.insert("line_height".to_string(), AttributeSpec {
        default: Some(Value::Number(serde_json::Number::from_f64(1.5).unwrap()))
    });
...
pub fn create_heading_node() -> Node {
    ...
    attrs.insert("id".to_string(), AttributeSpec {
        default: Some(Value::String("".to_string()))
    });
    attrs.insert("anchor".to_string(), AttributeSpec {
...
pub fn create_list_node() -> Node {
    let mut attrs = HashMap::new();
    attrs.insert("list_type".to_string(), AttributeSpec {
        default: Some(Value::String("bullet".to_string())) // bullet, ordered, todo
    });
    attrs.insert("tight".to_string(), AttributeSpec {
        default: Some(Value::Bool(false))
    });
    attrs.insert("start".to_string(), AttributeSpec {
        default: Some(Value::Number(serde_json::Number::from(1)))
    });
...
pub fn create_list_item_node() -> Node {
    let mut attrs = HashMap::new();
    attrs.insert("checked".to_string(), AttributeSpec {
...
pub fn create_table_node() -> Node {
    let mut attrs = HashMap::new();
    attrs.insert("rows".to_string(), AttributeSpec {
        default: Some(Value::Number(serde_json::Number::from(1)))
    });
    attrs.insert("cols".to_string(), AttributeSpec {
        default: Some(Value::Number(serde_json::Number::from(1)))
    });
    attrs.insert("has_header".to_string(), AttributeSpec {
        default: Some(Value::Bool(true))
    });
    attrs.insert("border".to_string(), AttributeSpec {
        default: Some(Value::Bool(true))
    });
...
pub fn create_table_cell_node() -> Node {
    let mut attrs = HashMap::new();
    attrs.insert("colspan".to_string(), AttributeSpec {
        default: Some(Value::Number(serde_json::Number::from(1)))
    });
    attrs.insert("rowspan".to_string(), AttributeSpec {
        default: Some(Value::Number(serde_json::Number::from(1)))
    });
    attrs.insert("align".to_string(), AttributeSpec {
        default: Some(Value::String("left".to_string()))
    });
    attrs.insert("is_header".to_string(), AttributeSpec {
        default: Some(Value::Bool(false))
    });
...
pub fn create_code_block_node() -> Node {
    let mut attrs = HashMap::new();
    attrs.insert("language".to_string(), AttributeSpec {
        default: Some(Value::String("".to_string()))
    });
    attrs.insert("line_numbers".to_string(), AttributeSpec {
        default: Some(Value::Bool(false))
    });
    attrs.insert("wrap".to_string(), AttributeSpec {
        default: Some(Value::Bool(false))
    });
