...
# ModuForge 生态系统
moduforge-model = { version = "0.4.9", path = "../model" }
moduforge-state = { version = "0.4.9", path = "../state" }
moduforge-transform = { version = "0.4.9", path = "../transform" }
moduforge-core = { version = "0.4.9", path = "../core" }
```
