...
impl MainWorkerFactory {
    pub fn new() -> Self {
        Self { table: MainWorkersTable::new() }
    }
    pub fn worker_exists(
        &self,
        id: MainWorkerId,
    ) -> bool {
    ...
    pub fn create_main_worker(
        ...
        let thread_builder =
            std::thread::Builder::new().name(format!("main_{worker_id}"));
    ...
    pub fn create_custom_worker(
        ...
        let permission_desc_parser: Arc<
            RuntimePermissionDescriptorParser<sys_traits::impls::RealSys>,
