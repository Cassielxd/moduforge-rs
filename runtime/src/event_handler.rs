...
use moduforge_delta::{delta::{create_tr_snapshot, to_delta}, snapshot::create_full_snapshot};
...
pub fn create_snapshot_handler(storage_path: PathBuf, snapshot_interval: usize) -> SnapshotHandler {
    SnapshotHandler { storage_path, snapshot_interval, counter: AtomicUsize::new(0) }
}
