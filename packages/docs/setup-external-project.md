...
[dependencies]
# 核心依赖
moduforge-core = "0.4.4"
moduforge-model = "0.4.4" 
moduforge-state = "0.4.4"
moduforge-transform = "0.4.4"
moduforge-rules-engine = "0.4.4"
moduforge-rules-expression = "0.4.4"
moduforge-collaboration = "0.4.4"
moduforge-template = "0.4.4"
...
```rust
// main.rs 或 lib.rs
use moduforge_core::{ForgeResult, async_runtime::ForgeAsyncRuntime, types::RuntimeOptions};
...
```rust
use moduforge_state::{State, StateConfig, Transaction};
use std::sync::Arc;
...
use moduforge_core::{ForgeResult, async_runtime::ForgeAsyncRuntime, types::RuntimeOptions};
use moduforge_state::transaction::Transaction;
use moduforge_collaboration::sync_service::SyncService;
