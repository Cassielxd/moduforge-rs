...
5. **[性能优化指南](./performance-guide.md)** - 掌握高性能应用开发技巧
6. **[外部项目集成](./setup-external-project.md)** - 将框架集成到现有项目

### 🏗️ 架构设计参考
7. **[应用场景分析](./architecture_use_cases.md)** - 了解框架适用的业务场景
8. **[架构限制分析](./architecture_limitations_analysis.md)** - 客观了解框架的优势与限制
9. **[业务依赖设计](./business_dependency_design.md)** - 复杂业务间依赖的设计方案

### 💼 实际业务应用
10. **[节点预算映射](./node-budget-mapping.md)** - 框架到实际业务的映射示例
11. **[元数据依赖设计](./meta_based_dependency_design.md)** - 轻量级业务依赖方案
...
- **🔧 开发者**: quick-start.md → plugin-development-guide.md → performance-guide.md
