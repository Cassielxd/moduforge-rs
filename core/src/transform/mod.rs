...
impl Step for ConcreteStep {
    fn apply(&self, doc: std::sync::Arc<crate::model::node_pool::NodePool>, schema: std::sync::Arc<crate::model::schema::Schema>) -> Result<step::StepResult, transform::TransformError> {
        match self {
